// TODO:
// 1. Реализовать загрузку карточек по нажатию на кнопку "Загрузить еще"
// 2. Реализовать максимальное количество карточек, которое можно загрузить (8 штук)
// 3. Реализовать кнопку "Загрузить еще", которая будет скрываться, когда карточек больше нет
// 4. React Router основные страницы, Header, Footer, Favorite
// 5. Реализовать добавление и удаление из избранного
